...
def main():
    ...
    assert( outputs[0]    == 0.46312425982939409 )
    ...
    assert( outputs[0]    == 2.6551249810501929 )
    ...
    assert( outputs[0]    == 0.99999999259944161 )
    assert( outputs[1][0] == 2.0 )
    assert( outputs[1][1] == 3.9999971238090994 )        
    ...
    assert( outputs[0]    == 388.82335348871243 )
    assert( outputs[1][0] == -0.98721927123333564 )
    assert( outputs[1][1] == -0.98721949140835652 )      

...
# the aero methods
from SUAVE.Methods.Aerodynamics import CFD_Slices as Methods
...
class CFD_Slices(Markup):
    ...
    def __defaults__(self):
        ...
        settings.airfoil_drag_surrogate             = None
        settings.sections_per_segment               = 10
        settings.mach_cutoff                        = .7
        ...
        compute.lift.compressible_wings            = FZ.Lift.wing_compressibility_correction
    ...
    def initialize(self):
        ...
        drag_surrogate, point_scale          = Methods.create_drag_surrogate()
        self.settings.airfoil_drag_surrogate = drag_surrogate
        self.settings.surrogate_scale        = point_scale

...
#-------------------------------------------------------------------------------
    ...
    rProp               = config.propulsors.propulsor.propeller_lift.prop_attributes.tip_radius
    ...
    output.motors           = (nLiftProps + nThrustProps)* 10. *Units.kg
    output.battery          = mBattery *Units.kg
    output.servos           = (nLiftProps + nThrustProps)* 0.65 *Units.kg
    output.brs              = 16. *Units.kg
    output.hubs             = (nLiftProps + nThrustProps) * 2. *Units.kg
